 ...
 */
  override preSynthesize(): void {
    ...
    const header =
      ["@yaml-language-server $schema=https://json.schemastore.org/pnpm-workspace.json", "Temporary pnpm-workspace.yaml generated by projen during preSynthesis"].map(line => `# ${line}`).join("\n") + "\n";
