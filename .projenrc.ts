...
// Python uv workspace
// ---------------------------------------------------------------------------
// Python packages use one root uv workspace but remain outside the JavaScript
...
new TextFile(root, "pyproject.toml", {
  marker: false,
  readonly: true,
  lines: [
