 ...
 * in `@dbx-tools/ai-search`, the Mastra tool, the `POST /api/search` route,
 ...
 * `POST /api/ai-search/index` body). Two shapes, both inferring aggressively:
...
/** Schema for the `sync_index` tool input / the `POST /api/ai-search/index/sync` body. */
