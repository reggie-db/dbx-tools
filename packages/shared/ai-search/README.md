...
[`@dbx-tools/ai-search`](../../node/ai-search) reads and writes.
...
```ts
import { search, type SearchRequest } from "@dbx-tools/shared-ai-search";
...
in [`@dbx-tools/ai-search`](../../node/ai-search). The React search box lives in
[`@dbx-tools/ui-ai-search`](../../ui/ai-search).
