...
export function canonicalScopes(scopes: Array<string>): Array<string> {
    const __rb: Uint8Array = uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_canonical_scopes(
...
export async function createPersistentAuth(options: DatabricksAuthOptions, storage: Storage | undefined = undefined, asyncOpts_?: { signal: AbortSignal }): Promise<PersistentAuthLike> /*throws*/ {
    ...
    try {
        return await uniffiRustCallAsync(
            ...
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_create_persistent_auth(FfiConverterTypeDatabricksAuthOptions.lower(options, nativeModule().rustbuffer_alloc),FfiConverterOptionalTypeStorage.lower(storage, nativeModule().rustbuffer_alloc)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_u64,
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_cancel_u64,
            /*completeFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_complete_u64,
            /*freeFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_free_u64,
...
export async function createPersistentAuthWithStorage(options: DatabricksAuthOptions, storage: StorageHandleLike, asyncOpts_?: { signal: AbortSignal }): Promise<PersistentAuthLike> /*throws*/ {
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_create_persistent_auth_with_storage(FfiConverterTypeDatabricksAuthOptions.lower(options, nativeModule().rustbuffer_alloc),FfiConverterTypeStorageHandle.lower(storage, nativeModule().rustbuffer_alloc)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_u64,
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_cancel_u64,
...
export async function createProviderAuth(options: ProviderOptions, asyncOpts_?: { signal: AbortSignal }): Promise<ProviderAuthLike> /*throws*/ {
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_create_provider_auth(FfiConverterTypeProviderOptions.lower(options, nativeModule().rustbuffer_alloc)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_u64,
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_cancel_u64,
...
export async function createProviderAuthWithStorage(options: ProviderOptions, storage: StorageHandleLike, asyncOpts_?: { signal: AbortSignal }): Promise<ProviderAuthLike> /*throws*/ {
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_create_provider_auth_with_storage(FfiConverterTypeProviderOptions.lower(options, nativeModule().rustbuffer_alloc),FfiConverterTypeStorageHandle.lower(storage, nativeModule().rustbuffer_alloc)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_u64,
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_cancel_u64,
...
export function createStorageHandle(storage: StorageAdapter): StorageHandleLike {
    return FfiConverterTypeStorageHandle.lift(uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_create_storage_handle(
...
export function credentialKey(provider: string, profile: string | undefined, scopes: Array<string>): string {
    const __rb: Uint8Array = uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_credential_key(
...
export function databricksCliAvailable(): boolean {
    return FfiConverterBool.lift(uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_databricks_cli_available(
                callStatus);
            },
            /*liftString:*/ FfiConverterString.lift.bind(FfiConverterString),
    ));
...
export function parseAddress(input: string | undefined): ParsedAddress {
    const __rb: Uint8Array = uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_parse_address(
...
export function parseResourcePath(input: string | undefined): ParsedAddress {
    const __rb: Uint8Array = uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_core_fn_func_parse_resource_path(
        FfiConverterOptionalString.lower(input, nativeModule().rustbuffer_alloc),
                callStatus);
            },
            /*liftString:*/ FfiConverterString.lift.bind(FfiConverterString),
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            ...
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_cancel_rust_buffer,
            /*completeFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_complete_rust_buffer,
            /*freeFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_free_rust_buffer,
            // Async returns always go through the JS-side converter: the
            // FFI symbol returns the future handle (u64), and the user-level
            // RustBuffer comes back via the shared `rust_future_complete_*`
            // export. The bytes the runtime hands back must be deserialized
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_persistentauth_challenge(
                    uniffiTypePersistentAuthObjectFactory.clonePointer(this)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_void,
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_cancel_void,
            /*completeFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_complete_void,
            /*freeFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_free_void,
            /*liftFunc:*/ (_v) => {},
            /*liftString:*/ FfiConverterString.lift.bind(FfiConverterString),
            /*asyncOpts:*/ asyncOpts_,
            /*errorHandler:*/ FfiConverterTypeAuthError.lift.bind(FfiConverterTypeAuthError)
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_persistentauth_logout(
                    uniffiTypePersistentAuthObjectFactory.clonePointer(this)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_void,
 ...
 */
    ...
    const __rb: Uint8Array = uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_persistentauth_status(
                uniffiTypePersistentAuthObjectFactory.clonePointer(this),
                callStatus);
            },
            /*liftString:*/ FfiConverterString.lift.bind(FfiConverterString),
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_persistentauth_token(
                    uniffiTypePersistentAuthObjectFactory.clonePointer(this),FfiConverterOptionalBoolean.lower(login, nativeModule().rustbuffer_alloc)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_rust_buffer,
...
const uniffiTypePersistentAuthObjectFactory: UniffiObjectFactory<PersistentAuthLike> = (() => {
    ...
    clonePointer(obj_: PersistentAuthLike): UniffiHandle {
        ...
        return uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_core_fn_clone_persistentauth(pointer, callStatus),
    ...
    freePointer(pointer: UniffiHandle): void {
        uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_core_fn_free_persistentauth(pointer, callStatus),
            /*liftString:*/ FfiConverterString.lift
        );
    },
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_providerauth_logout(
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_providerauth_token(
                    uniffiTypeProviderAuthObjectFactory.clonePointer(this),FfiConverterOptionalBoolean.lower(login, nativeModule().rustbuffer_alloc)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_rust_buffer,
...
const uniffiTypeProviderAuthObjectFactory: UniffiObjectFactory<ProviderAuthLike> = (() => {
    ...
    clonePointer(obj_: ProviderAuthLike): UniffiHandle {
        const pointer = this.pointer(obj_);
        return uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_core_fn_clone_providerauth(pointer, callStatus),
            /*liftString:*/ FfiConverterString.lift
        );
    },
    ...
    freePointer(pointer: UniffiHandle): void {
        uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_core_fn_free_providerauth(pointer, callStatus),
            /*liftString:*/ FfiConverterString.lift
        );
    },
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_storageadapter_load(
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_storageadapter_prepare_write(
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_storageadapter_save(
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_storageadapter_remove(
                    uniffiTypeStorageAdapterImplObjectFactory.clonePointer(this),FfiConverterString.lower(profile, nativeModule().rustbuffer_alloc)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_core_rust_future_poll_void,
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_storageadapter_acquire_lock(
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_storageadapter_release_lock(
 ...
 */
    ...
    const __rb: Uint8Array = uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_core_fn_method_storageadapter_name(
                uniffiTypeStorageAdapterImplObjectFactory.clonePointer(this),
                callStatus);
            },
            /*liftString:*/ FfiConverterString.lift.bind(FfiConverterString),
...
const uniffiTypeStorageAdapterImplObjectFactory: UniffiObjectFactory<StorageAdapter> = (() => {
    ...
    clonePointer(obj_: StorageAdapter): UniffiHandle {
        const pointer = this.pointer(obj_);
        return uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_core_fn_clone_storageadapter(pointer, callStatus),
            /*liftString:*/ FfiConverterString.lift
        );
    },
    ...
    freePointer(pointer: UniffiHandle): void {
        uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_core_fn_free_storageadapter(pointer, callStatus),
            /*liftString:*/ FfiConverterString.lift
        );
    },
...
const uniffiCallbackInterfaceStorageAdapter: { vtable: any; register: () => void; } = {
    ...
    register: () => {nativeModule().uniffi_dbx_tools_core_fn_init_callback_vtable_storageadapter(
...
const uniffiTypeStorageHandleObjectFactory: UniffiObjectFactory<StorageHandleLike> = (() => {
    ...
    clonePointer(obj_: StorageHandleLike): UniffiHandle {
        const pointer = this.pointer(obj_);
        return uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_core_fn_clone_storagehandle(pointer, callStatus),
            /*liftString:*/ FfiConverterString.lift
        );
    },
    ...
    freePointer(pointer: UniffiHandle): void {
        uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_core_fn_free_storagehandle(pointer, callStatus),
            /*liftString:*/ FfiConverterString.lift
        );
    },
...
function uniffiEnsureInitialized() {
    ...
    const scaffoldingContractVersion = nativeModule().ffi_dbx_tools_core_uniffi_contract_version();
    ...
    if (nativeModule().uniffi_dbx_tools_core_checksum_func_create_persistent_auth() !== 18830) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_func_create_persistent_auth");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_func_create_persistent_auth_with_storage() !== 22339) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_func_create_persistent_auth_with_storage");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_func_create_provider_auth() !== 4445) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_func_create_provider_auth");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_func_create_provider_auth_with_storage() !== 46166) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_func_create_provider_auth_with_storage");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_func_create_storage_handle() !== 15610) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_func_create_storage_handle");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_func_credential_key() !== 36458) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_func_credential_key");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_func_databricks_cli_available() !== 27788) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_func_databricks_cli_available");
    }
    ...
    if (nativeModule().uniffi_dbx_tools_core_checksum_method_storageadapter_load() !== 54668) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_method_storageadapter_load");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_method_storageadapter_prepare_write() !== 45067) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_method_storageadapter_prepare_write");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_method_storageadapter_save() !== 63958) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_method_storageadapter_save");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_method_storageadapter_remove() !== 16750) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_method_storageadapter_remove");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_method_storageadapter_acquire_lock() !== 64986) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_method_storageadapter_acquire_lock");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_method_storageadapter_release_lock() !== 64198) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_method_storageadapter_release_lock");
    }
    if (nativeModule().uniffi_dbx_tools_core_checksum_method_storageadapter_name() !== 6080) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dbx_tools_core_checksum_method_storageadapter_name");
    }
