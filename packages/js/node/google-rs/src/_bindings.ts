...
export async function createGoogleAuth(options: GoogleAuthOptions, asyncOpts_?: { signal: AbortSignal }): Promise<GoogleAuthLike> /*throws*/ {
    ...
    try {
        return await uniffiRustCallAsync(
            ...
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_google_fn_func_create_google_auth(FfiConverterTypeGoogleAuthOptions.lower(options, nativeModule().rustbuffer_alloc)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_poll_u64,
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_cancel_u64,
            /*completeFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_complete_u64,
            /*freeFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_free_u64,
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            ...
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_cancel_rust_buffer,
            /*completeFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_complete_rust_buffer,
            /*freeFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_free_rust_buffer,
            // Async returns always go through the JS-side converter: the
            // FFI symbol returns the future handle (u64), and the user-level
            // RustBuffer comes back via the shared `rust_future_complete_*`
            // export. The bytes the runtime hands back must be deserialized
 ...
 */
    ...
    try {
        return await uniffiRustCallAsync(
            /*rustCaller:*/ uniffiCaller,
            /*rustFutureFunc:*/ () => {
                return nativeModule().uniffi_dbx_tools_google_fn_method_googleauth_logout(
                    uniffiTypeGoogleAuthObjectFactory.clonePointer(this)
                );
            },
            /*pollFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_poll_void,
            /*cancelFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_cancel_void,
            /*completeFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_complete_void,
            /*freeFunc:*/ nativeModule().ffi_dbx_tools_google_rust_future_free_void,
            /*liftFunc:*/ (_v) => {},
            /*liftString:*/ FfiConverterString.lift.bind(FfiConverterString),
            /*asyncOpts:*/ asyncOpts_,
            /*errorHandler:*/ FfiConverterTypeAuthError.lift.bind(FfiConverterTypeAuthError)
 ...
 */
    ...
    const __rb: Uint8Array = uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().uniffi_dbx_tools_google_fn_method_googleauth_status(
                uniffiTypeGoogleAuthObjectFactory.clonePointer(this),
                callStatus);
            },
            /*liftString:*/ FfiConverterString.lift.bind(FfiConverterString),
...
const uniffiTypeGoogleAuthObjectFactory: UniffiObjectFactory<GoogleAuthLike> = (() => {
    ...
    clonePointer(obj_: GoogleAuthLike): UniffiHandle {
        ...
        return uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_google_fn_clone_googleauth(pointer, callStatus),
    ...
    freePointer(pointer: UniffiHandle): void {
        uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => nativeModule().uniffi_dbx_tools_google_fn_free_googleauth(pointer, callStatus),
            /*liftString:*/ FfiConverterString.lift
        );
    },
...
function uniffiEnsureInitialized() {
    ...
    const scaffoldingContractVersion = nativeModule().ffi_dbx_tools_google_uniffi_contract_version();
